...
var divarr = createElements('div', 'offset-md-2 offset-sm-1 row text-md-center text-sm-left h4 mb-0', 7);

var input = create('input', 'col-6 border-3 border-light text-right mt-5 mb-1');
input.setAttribute('type', 'text');
input.disabled = true;
input.setAttribute('style', `line-height:60px; background-color:#728FCE; font-family: 'Comfortaa', cursive;`);
input.id = "display";
...
div1.append(divarr[0], divarr[1], divarr[2], divarr[3], divarr[4], divarr[5],divarr[6]);
divarr[0].append(input);
divarr[1].append(add, sub, mul, division);
divarr[2].append( root,division,dot);
divarr[3].append(btnnumbers[7], btnnumbers[8], btnnumbers[9]);
divarr[4].append(btnnumbers[4], btnnumbers[5], btnnumbers[6]);
divarr[5].append(btnnumbers[1], btnnumbers[2], btnnumbers[3],);
divarr[6].append(btnnumbers[0],  clear,equals);
